...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to,'The given address is the owner of the token');
        require(owner == msg.sender || isApprovedForAll(owner, msg.sender), 'Caller must be the owner of the contract or must be approved for all');
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != from, 'Given address is invalid');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        require(from == ownerOf(tokenId), 'Invalid, not the owner');
        require(to != address(0), 'Invalid address, transfer not allowed');
